...
1. Create an interface on your mobile device. One option for doing this is to use an application like TouchOSC (iOS or Android, $5) or mrmr (iOS, free) or oscHook (Android, free), or [Sensors2OSC(Android,free)](https://sensors2.org/osc/) or [Data OSC](https://apps.apple.com/us/app/data-osc/id6447833736).  At minimum, your interface should use the accelerometer in some meaningful way. At best, experiment with a variety of sensors and/or touch controls.
